...
Public Class FormSuppliersPayeeAdd
    Public Shared FSPAClosed = False
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            MyDataAdapter.Parameters("@SUPPLIER_PAYEE_ID").Value = vbNull
            '---------------------------------------------------------------------------------------
            MyDataAdapter.Parameters.Add(New SqlParameter("@SUPPLIER_PAYEE_NAME", SqlDbType.VarChar, 100))
            MyDataAdapter.Parameters("@SUPPLIER_PAYEE_NAME").Value = TextBox1.Text
            '---------------------------------------------------------------------------------------
